...
function licenseStatusText(x){return x==='active'?'有效':(x==='disabled'?'已禁用':esc(x))}
...
q('licenseResetBtn').addEventListener('click',function(){q('licenseSearch').value='';q('licenseStatusFilter').value='';loadLicenses(true)});
